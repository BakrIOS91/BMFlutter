...
///
/// **Best for:** Transient states, caches that should reset on app restart,
/// or sensitive data that should never touch the disk.
/// **Storage:** Memory (RAM). Disappears when the process is killed.
///
/// ### Scenario: Session Data
/// ```dart
/// @GeneratePreferences()
/// class SessionPrefs extends BasePreferences with _$SessionPrefs {
///   @InApp()
///   late final bool _isTempFeatureEnabled = false;
/// }
/// ```
class InApp {
  const InApp();
